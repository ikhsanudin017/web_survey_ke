...
CREATE TABLE "public"."financing_analyses" (
    ...
    "jenisJaminan" TEXT,
    "nilaiTaksiran" DECIMAL(65,30),
    "kondisiJaminan" TEXT,
    "nilaiJaminanSetelahPotongan" DECIMAL(65,30),
    "validInvalid" TEXT,
...
CREATE TABLE "public"."sub_financing_analyses" (
    ...
    "angsuranMaksimal" DECIMAL(65,30) NOT NULL,
    "plafonMaksimal" DECIMAL(65,30) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."bi_checking" (
    "id" TEXT NOT NULL,
    "applicationId" TEXT NOT NULL,
    ...
    CONSTRAINT "bi_checking_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "public"."enhanced_analyses" (
    "id" TEXT NOT NULL,
    "applicationId" TEXT NOT NULL,
    ...
    CONSTRAINT "enhanced_analyses_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "bi_checking_applicationId_key" ON "public"."bi_checking"("applicationId");
...
-- AddForeignKey
ALTER TABLE "public"."bi_checking" ADD CONSTRAINT "bi_checking_applicationId_fkey" FOREIGN KEY ("applicationId") REFERENCES "public"."financing_applications"("id") ON DELETE CASCADE ON UPDATE CASCADE;
