            ...
            <div className="space-y-4 bg-green-50 p-4 rounded-lg">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input value={formData.nama} readOnly className="bg-gray-100" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Alamat:</label>
                  <Input value={formData.alamat} readOnly className="bg-gray-100" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Jenis Usaha:</label>
                  <Input value={formData.jenisUsaha} readOnly className="bg-gray-100" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Pengajuan:</label>
                  <Input value={formData.pengajuan} readOnly className="bg-gray-100" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Jangka Waktu:</label>
                  <Input value={formData.jangkaWaktu} readOnly className="bg-gray-100" />
                </div>
              </div>
            </div>
